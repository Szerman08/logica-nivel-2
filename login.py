...
def verificar_login():
    ...
    if login == "XPTO" and senha == "12345678":
        messagebox.showinfo("Login", "Acesso liberado")
        abrir_menu()
    else:
...
def abrir_menu():
    ...
    tk.Label(menu_janela, text="Escolha uma opção:").grid(row=0, column=0, columnspan=2)

    btn_calculadora = tk.Button(menu_janela, text="1 - Calculadora", command=abrir_calculadora, width=20)
    btn_calculadora.grid(row=1, column=0, columnspan=2)

    btn_imc = tk.Button(menu_janela, text="2 - IMC", command=abrir_imc, width=20)
    btn_imc.grid(row=2, column=0, columnspan=2)

    btn_idade = tk.Button(menu_janela, text="3 - Idade", command=abrir_idade, width=20)
    btn_idade.grid(row=3, column=0, columnspan=2)

    btn_voltar = tk.Button(menu_janela, text="Voltar", command=menu_janela.destroy, width=20)
...
btn_sair.grid(row=3, column=0, columnspan=2)
